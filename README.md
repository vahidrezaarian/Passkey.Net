...
Or in your .csproj:
```XML
<PackageReference Include="Passkey.Net" Version="1.2.0" />
```

The latest version: https://www.nuget.org/packages/Passkey.Net/1.2.0
...
{
    var passkey = new Passkey(device, UserActionCallback)
